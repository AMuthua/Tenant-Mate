          ...
          children: <Widget>[
            ...
            TextField(
              ...
              decoration: const InputDecoration(
                labelText: 'Enter Phone Number (254...)',
            ...
            ElevatedButton(
              onPressed: () async {
                ...
                if (phoneNumber.isNotEmpty) {
                  await _initiateMpesaPayment(context, rentAmount, phoneNumber);
                } else {
                  ScaffoldMessenger.of(context).showSnackBar(
  ...
  Future<void> _initiateMpesaPayment(BuildContext context, double amount, String phone) async {
    try {
      ...
      dynamic transactionInitialisation =
        ...
        transactionType: TransactionType.CustomerPayBillOnline,
        amount: amount,
        partyA: phone, // Use the phone number from the input field
        partyB: "174379",
        callBackURL: Uri(
            scheme: "https", host: "1234.1234.co.ke", path: "/1234.php"),
        accountReference: "Rent Payment",
        phoneNumber: phone, // Use the phone number from the input field
        baseUri: Uri(scheme: "https", host: "sandbox.safaricom.co.ke"),
        transactionDesc: "Rent Payment Demo",
        passKey: passKey, // Use the passKey from your keys.dart file
      );
